...
include_once $this->targetDirs[3].'/src/DataFixtures/TarifFixtures.php';
include_once $this->targetDirs[3].'/src/DataFixtures/UtilisateurFixtures.php';

$a = new \Doctrine\Bundle\FixturesBundle\Loader\SymfonyFixturesLoader($this);
$a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AppFixtures(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\TarifFixtures(), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\UtilisateurFixtures(($this->services['security.password_encoder'] ?? $this->load('getSecurity_PasswordEncoderService.php'))), 'groups' => []]]);
