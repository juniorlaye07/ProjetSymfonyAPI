...
class __TwigTemplate_ce388752edb2aa588ced9757b03c22042ec2525a96f54724c123079f5a5e3d15 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["transactions"]) || array_key_exists("transactions", $context) ? $context["transactions"] : (function () { throw new RuntimeError('Variable "transactions" does not exist.', 16, $this->source); })()));
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["transaction"]) {
            ...
            echo "            <tr>
                <td>";
            // line 18
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["transaction"], "id", [], "any", false, false, false, 18), "html", null, true);
            echo "</td>
                <td>
                    <a href=\"";
            // line 20
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("transaction_show", ["id" => twig_get_attribute($this->env, $this->source, $context["transaction"], "id", [], "any", false, false, false, 20)]), "html", null, true);
            echo "\">show</a>
                    <a href=\"";
            // line 21
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("transaction_edit", ["id" => twig_get_attribute($this->env, $this->source, $context["transaction"], "id", [], "any", false, false, false, 21)]), "html", null, true);
            echo "\">edit</a>
                </td>
            </tr>
        ";
...
{% endblock %}
", "transaction/index.html.twig", "/home/juniorlaye/ProjetAPISymfony/templates/transaction/index.html.twig");
    }
}
