...
class __TwigTemplate_523d3d8ba6a313d69075646bb6bd496f266251099335f84b1a8b1a855572b7a2 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <a href=\"";
        // line 19
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("transaction_edit", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["transaction"]) || array_key_exists("transaction", $context) ? $context["transaction"] : (function () { throw new RuntimeError('Variable "transaction" does not exist.', 19, $this->source); })()), "id", [], "any", false, false, false, 19)]), "html", null, true);
        echo "\">edit</a>
...
{% endblock %}
", "transaction/show.html.twig", "/home/juniorlaye/ProjetAPISymfony/templates/transaction/show.html.twig");
    }
}
