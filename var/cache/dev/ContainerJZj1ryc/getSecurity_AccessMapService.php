...
$instance->add($a, [0 => 'ROLE_SUPER_ADMINPRESTA'], NULL);
$instance->add($a, [0 => 'ROLE_SUPER_ADMINSYSTEME'], NULL);
$instance->add($a, [0 => 'ROLE_ADMINPRESTA'], NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/super/partenaire'), [0 => 'ROLE_SUPER_ADMINSYSTEME'], NULL);
